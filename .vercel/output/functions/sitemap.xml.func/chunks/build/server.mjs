...
import { l as getContext, $ as $fetch, m as baseURL, h as publicAssetsURL, n as createHooks, o as executeAsync, j as createError$1, p as parseQuery, q as hasProtocol, s as joinURL, v as toRouteMatcher, w as createRouter$1, x as defu, y as getRequestHeaders, z as withQuery, A as sanitizeStatusCode, B as withTrailingSlash, C as withoutTrailingSlash, D as isScriptProtocol } from '../_/nitro.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="py-16"><div class="text-center"><p class="text-sm font-semibold text-primary-600 uppercase tracking-wide">${ssrInterpolate(__props.error.statusCode)} 错误 </p><h1 class="mt-2 text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">${ssrInterpolate(__props.error.statusCode === 404 ? "页面不存在" : "出错了")}</h1><p class="mt-2 text-base text-gray-500">${ssrInterpolate(__props.error.message || "抱歉，发生了一些错误。")}</p><div class="mt-6 flex justify-center space-x-4">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
      ...
      if (__props.error.statusCode !== 404) {
        _push(`<button class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"> 重试 </button>`);
      } else {
        _push(`<!---->`);
      }
