...
import { c as buildAssetsURL, a as useRuntimeConfig, g as getResponseStatusText, e as getResponseStatus, f as defineRenderHandler, h as publicAssetsURL, i as getQuery, j as createError, k as getRouteRules, u as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"基于AI的产品经理岗位JD智能解析工具，帮助产品经理小白快速理解岗位核心能力要求、岗位条件需求和核心产出物。"}],"link":[],"style":[],"script":[],"noscript":[],"title":"JD Insight - 产品经理岗位智能解析工具"};
