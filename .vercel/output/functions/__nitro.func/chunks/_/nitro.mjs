...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "9982b878-e38f-495c-8430-af1d7f3d95ab",
...
const _lazy_2tEYRK = () => import('../routes/api/sitemap.mjs');
const _lazy_BmwYjf = () => import('../routes/api/v1/analyze.post.mjs');
const _lazy_grAM2I = () => import('../routes/api/v1/feedback.post.mjs');
const _lazy_Cmrlui = () => import('../routes/api/v1/image-recognition.post.mjs');
...
const handlers = [
  { route: '/api/sitemap', handler: _lazy_2tEYRK, lazy: true, middleware: false, method: undefined },
  ...
  { route: '/api/v1/image-recognition', handler: _lazy_Cmrlui, lazy: true, middleware: false, method: "post" },
...
export { $fetch as $, sanitizeStatusCode as A, withTrailingSlash as B, withoutTrailingSlash as C, isScriptProtocol as D, useRuntimeConfig as a, readBody as b, buildAssetsURL as c, defineEventHandler as d, getResponseStatus as e, defineRenderHandler as f, getResponseStatusText as g, publicAssetsURL as h, getQuery as i, createError$1 as j, getRouteRules as k, getContext as l, baseURL as m, createHooks as n, executeAsync as o, parseQuery as p, hasProtocol as q, readMultipartFormData as r, joinURL as s, toNodeListener as t, useNitroApp as u, toRouteMatcher as v, createRouter$1 as w, defu as x, getRequestHeaders as y, withQuery as z };
